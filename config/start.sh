...
function configureDrupal() {
	if [ -f /var/www/sites/default/settings.php ]; then
		# cat /etc/settings.php.append >> /var/www/sites/default/settings.php
		# rm /etc/settings.php.append

		cp /opt/status.php /var/www/status.php

		# drush vset cache 1 
		# drush vset page_cache_maximum_age 3600 
		# drush vset varnish_version 3 

		echo "Varnish and Memcache configured in settings.php file, you should download and install the modules too"
	fi
}
